...
void Countdown::render() {
	TextureManager::draw(boxTexture, srcRectBox, destRectBox);
	
	TextureManager::draw(digitsTexture[(int)timeLeft / 60 / 10], srcRectDigits, destRectDigits[0]);
	TextureManager::draw(digitsTexture[(int)timeLeft / 60 % 10], srcRectDigits, destRectDigits[1]);
	TextureManager::draw(digitsTexture[(int)timeLeft % 60 / 10], srcRectDigits, destRectDigits[2]);
	TextureManager::draw(digitsTexture[(int)timeLeft % 60 % 10], srcRectDigits, destRectDigits[3]);
}
